...
created: "2018-02-25"
modified: "2018-02-25"
url: https://raw.githubusercontent.com/streamdata-gallery/predictions/master/_listings/google-cloud-prediction/apis.yaml
...
- name: Google Cloud Prediction API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/predictions/master/_listings/google-cloud-prediction/project-trainedmodels-id-predict-post.md
x-common:
- type: x-bugs
